...
private class ConfirmDialogHandleImpl(
    ...
    override suspend fun awaitConfirm(
        ...
        return suspendCancellableCoroutine { cont ->
            awaitContinuation = cont.apply { invokeOnCancellation { visible.value = false } }
        }
    }
}
    ...
    return remember {
        object : ConfirmCallback {
            override val onConfirm
                get() = currentOnConfirm
            override val onDismiss
                get() = currentOnDismiss
        }
    }
}
...
fun rememberConfirmDialog(callback: ConfirmCallback): ConfirmDialogHandle {
    ...
    val handle = remember { ConfirmDialogHandleImpl(visible, scope, callback, resultChannel) }
